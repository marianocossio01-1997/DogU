...
export const createDriverPosition = async (data) => {
...
export const getDriverPosition = async (id_driver) => {
...
export const deleteDriverPosition = async (id_driver) => {
...
//# sourceMappingURL=driver_position.service.js.map